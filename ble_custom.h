...
#define CYBLE_AMPFREQ_SERVICE_INDEX   (0x00u) /* Index of ampfreq service in the cyBle_customs array */
#define CYBLE_AMPFREQ_AMPLITUDE_CHAR_INDEX   (0x00u) /* Index of Amplitude characteristic */
#define CYBLE_AMPFREQ_AMPLITUDE_CHARACTERISTIC_USER_DESCRIPTION_DESC_INDEX   (0x00u) /* Index of Characteristic User Description descriptor */
#define CYBLE_AMPFREQ_FREQUENCY_CHAR_INDEX   (0x01u) /* Index of Frequency characteristic */
#define CYBLE_AMPFREQ_FREQUENCY_CHARACTERISTIC_USER_DESCRIPTION_DESC_INDEX   (0x00u) /* Index of Characteristic User Description descriptor */


#define CYBLE_AMPFREQ_SERVICE_HANDLE   (0x0010u) /* Handle of ampfreq service */
#define CYBLE_AMPFREQ_AMPLITUDE_DECL_HANDLE   (0x0011u) /* Handle of Amplitude characteristic declaration */
#define CYBLE_AMPFREQ_AMPLITUDE_CHAR_HANDLE   (0x0012u) /* Handle of Amplitude characteristic */
#define CYBLE_AMPFREQ_AMPLITUDE_CHARACTERISTIC_USER_DESCRIPTION_DESC_HANDLE   (0x0013u) /* Handle of Characteristic User Description descriptor */
#define CYBLE_AMPFREQ_FREQUENCY_DECL_HANDLE   (0x0014u) /* Handle of Frequency characteristic declaration */
#define CYBLE_AMPFREQ_FREQUENCY_CHAR_HANDLE   (0x0015u) /* Handle of Frequency characteristic */
#define CYBLE_AMPFREQ_FREQUENCY_CHARACTERISTIC_USER_DESCRIPTION_DESC_HANDLE   (0x0016u) /* Handle of Characteristic User Description descriptor */
